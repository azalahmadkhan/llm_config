...
Instead, because this function only does delayed work, it is very fast
and so there is no reason to delay it.
...
`df.map_partitions`, or to turn your arrays or DataFrames into *many*
delayed objects.
